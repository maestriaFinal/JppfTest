...
public class TemplateApplicationRunner {
    ...
    /**
     * The entry point for this application runner to be run from a Java command
     * line.
     *
     * @param args by default, we do not use the command line arguments, however
     * nothing prevents us from using them if need be.
     */
     ...
     * you are encouraged to read the <a
     * href="http://www.jppf.org/doc/v4/index.php?title=Submitting_multiple_jobs_concurrently">dedicated
     * section</a>
